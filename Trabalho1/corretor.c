...
#include "AndreSantos_20231160020.h"
...
void testQ1()
{
    ...
    strcpy(str, "29/2/14");
    printf("%d\n", q1(str) == 0);
    strcpy(str, "29/2/2016");
    printf("%d\n", q1(str) == 1);
    strcpy(str, "29/2/2018");
    printf("%d\n", q1(str) == 0);
}
...
void testQ2()
{
  ...
  //teste 4
  strcpy(datainicial, "20/02/2017");
  strcpy(datafinal, "1/03/2017");
  dma = q2(datainicial, datafinal);
  printf("%d\n", dma.retorno == 1);
  printf("%d\n", dma.qtdDias == 7);
  printf("%d\n", dma.qtdMeses == 0);
  ...
  //teste 5
  strcpy(datainicial, "20/02/2020");
  strcpy(datafinal, "1/03/2020");
  dma = q2(datainicial, datafinal);
  printf("%d\n", dma.retorno == 1);
  printf("%d\n", dma.qtdDias == 8);
  printf("%d\n", dma.qtdMeses == 0);
